...
import { getMyPost, getWishlist, getMyReply } from '@src/api/userApi'
      ...
      {isPC && (
        <>
          ...
          <Inner>
            ...
            <PCList>
              <li>
                <Link to="/mypage/edit-info">회원 정보 변경</Link>
              </li>
              <li>
                <Link to="/help">고객센터</Link>
              </li>
              <li>
                <Link to="/mypage/edit-pw">비밀번호 변경</Link>
              </li>
              <li>
